...
# The final Python script will need to be able to deliver the following information when the script is run: 
...
with open(file_to_save, "w") as txt_file:
    ...
    county_results = (f"----------------------------------\n"
            f"Largest County Turnout: {winning_county}: {winning_county_turnout:.1f}% ({votes:,})\n"
            f"---------------------------------------------------\n"
            f"Candidate Results:\n")
    print(county_results)
